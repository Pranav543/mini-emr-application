...
app.add_middleware(CORSMiddleware, allow_origins=["http://localhost:3000", "https://mini-emr-application.netlify.app"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"]) 
